...
#   https://raw.githubusercontent.com/flop-labs/yellowpaper/main/evidence/compute-channel.py
# Source commit: 3eaf2f25bc46a501df225cae4e4e991975f6b2a9 (2026-09-10T02:16:17Z)
#   "docs(yellowpaper): sync verified 0.5.0 research draft"
# Fetched: 2026-09-10 via GitHub raw + https://api.github.com/repos/flop-labs/yellowpaper/commits
# License: CC BY 4.0, (c) 2026 FLOP Labs -- see vendor/LICENSE-yellowpaper (full text) and
#   https://creativecommons.org/licenses/by/4.0/legalcode
# Attribution: FLOP Labs, "FLOP Network Yellow Paper", 0.5.0 (draft), 2026,
#   https://github.com/flop-labs/yellowpaper
#
# DO NOT EDIT. This file is the canonical compute-channel wire-profile encoder (Appendix F).
# flopspend imports it rather than re-implementing SCALE/Merkle/domain-separated hashing.
# Changes made for vendoring: none to the code below this header (byte-for-byte as fetched).
